  ...
  return (
    <form onSubmit={handleSubmit} className="w-3/4 max-w-96">
      ...
      <div className="col-span-full mt-4">
        ...
        <div className="flex rounded-md ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-zinc-500 sm:max-w-md">
          <textarea
            id="message"
            name="message"
            ...
            rows={4}
            required
            className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-zinc-100 placeholder:text-zinc-500 focus:ring-0 sm:text-sm sm:leading-6 outline-none"
          />
        </div>
      </div>
      <Socials />
