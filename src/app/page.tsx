...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="absolute bottom-0 flex flex-col items-center justify-end w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
        <div
          className="text-sm text-zinc-400 max-w-md mt-2 animate-scroll-by "
          key={count}
        >
          {list[index]?.quote}
